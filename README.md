...
Deep Understanding of customers' wants and needs are key to driving supply chain efficiencies and an enhanced customer experience.  The *Intelligent Customer Care* solution equips Customer Care Representatives(CSRs) with deep customer insights in a natural language-based conversation interface to solve complex customer queries.
 
...
This was a high-level description of Intelligent Customer Care.  Learn more about it and other Intelligent Customer Care capabilities for developers at [IBM Developer](https://developer.ibm.com/components/sterling/)
